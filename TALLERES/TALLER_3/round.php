...
$calificaciones = [100, 12.3, 98.8, 99.9, 20.2];
...
$precios = [49.99, 23.45, 18.89, 7.65];
...
function redondeoPersonalizado($numero, $incremento = 0.1) {
    return round($numero / $incremento) * $incremento;
}

$valores = [5.75, 6.23, 7.89, 8.47];
echo "</br>Redondeo personalizado (incremento de 0.1):</br>";
foreach ($valores as $valor) {
    echo "Original: $valor, Redondeado: " . redondeoPersonalizado($valor) . "</br>";
}

// Ejemplo adicional: Redondeo en cálculos financieros
$cantidad = 7/9; // Esto resulta en un número periódico
echo "</br>División de 7/9:</br>";
