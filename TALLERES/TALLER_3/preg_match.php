...
$tweet = "Sígueme en @Paz03 para más contenido!";
...
$info = "Nombre: Victor, Edad: 20, Ciudad: Panama";
...
$telefono1 = "+1 1234567890";
$telefono2 = "+44-20-79460000";
$telefono3 = "12345678";
$telefono4 = "001-234-5678";
...
echo "¿'{$telefono4}' es un teléfono válido? " . (validarTelefono($telefono4) ? "Sí" : "No") . "</br>";
...
$html = "<div><p>Este es un enlace en un <a href='#'>párrafo</a>.</p></div>";
